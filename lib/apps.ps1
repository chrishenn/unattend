...
function waves {
    stop-service 'WavesSysSvc' -ea 0
    remove-service 'WavesSysSvc' -ea 0
    stop-service 'WavesAudioService' -ea 0
    remove-service 'WavesAudioService' -ea 0
