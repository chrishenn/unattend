...
if exist "..\resources\ame_wallpaper_4K.bmp" (
	copy /y "..\resources\ame_wallpaper_4K.bmp" "%WINDIR%\Web\Wallpaper\Windows"
...
if exist "..\resources\img0.jpg" (
	...
	copy /y "..\resources\img0.jpg" "%WINDIR%\Web\4K\Wallpaper\Windows\img0_1920x1200.jpg"
	takeown /f "%WINDIR%\Web\Wallpaper\Spotlight\img14.jpg"
	icacls "%WINDIR%\Web\Wallpaper\Spotlight\img14.jpg" /reset
	copy /y "..\resources\img0.jpg" "%WINDIR%\Web\Wallpaper\Spotlight\img14.jpg"
)
...
reg query "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Authentication\LogonUI\Creative\%~1" /v "RotatingLockScreen*" > NUL 2>&1
	if %errorlevel% NEQ 0 (
		...
		if exist "..\resources\img100.jpg" (
			takeown /f "%WINDIR%\Web\Screen\img100.jpg"
			icacls "%WINDIR%\Web\Screen\img100.jpg" /reset
			copy "..\resources\img100.jpg" "%WINDIR%\Web\Screen\img100.jpg" /Y
		)

		if exist "..\resources\img103.png" (
			takeown /f "%WINDIR%\Web\Screen\img103.png"
			icacls "%WINDIR%\Web\Screen\img103.png" /reset
			copy "..\resources\img103.png" "%WINDIR%\Web\Screen\img103.png" /Y
		)

		if exist "..\resources\img0.jpg" (
			takeown /f "%WINDIR%\Web\Wallpaper\Windows\img0.jpg"
			icacls "%WINDIR%\Web\Wallpaper\Windows\img0.jpg" /reset
			copy "..\resources\img0.jpg" "%WINDIR%\Web\Wallpaper\Windows\img0.jpg" /Y
		)
